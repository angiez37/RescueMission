...
public class CreekNavigate implements Navigate {
    ...
    public JSONObject search(Drone drone, Island island, Handler handler) {
        ...
        }else if ((drone.getHeading() == Direction.EAST && island.getForward() == Signal.OUTOFRANGE && island.getRight() == Signal.GROUND && island.getRightRange() == 0 && emptyFrontIteration == 0)) {
            if (forwardIteration == 0) {
                forwardIteration = 0;
                iteration = 0;
                handler.setCommand(Commands.FLY);
        ...
        } else if ((drone.getHeading() == Direction.EAST && island.getForward() == Signal.OUTOFRANGE && island.getRightRange() > 0 && emptyFrontIteration == 0)) {
